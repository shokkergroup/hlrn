...
- 197 currently published driver-frame mappings across 225 dossiers;
- source ID, timestamp, caption, and confidence label retained for each map;
- 143 name/scoring-graphic matches, 3 live-call matches, and 51 explicitly
  limited source-context frames;
- 197/197 unique frame hashes at 1280×720 or better;
- 28 monogram fallbacks when a safe mapping has not been made.
...
- **Highline Live shelves:** seven source-declared filters compartmentalize
  ...
  bonus universe.
- **Public language gate:** 4,378 authored fields / 109,654 words are scanned for
...
| Visual Garage + Photo Desk | 197 unique driver frames and 20 Central frames with source playback |
...
- 197 of 225 driver dossiers have mapped HLRN source frames; the other 28 keep
